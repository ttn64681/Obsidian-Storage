...
- ssd has shortcut from earlier low level layers all the way to output final prediction layer
- it sends earlier feature maps to final layer, why?
	- if you have a small object in image, when you shrink it several times, you lose the small object
	- to prevent that, you send intermediate feature layers to end
	- this can help preserve those objects
- this is important for bounding, but not for classification.
