...
- We prefer a surface with skip connections (less local minima )vs surface w/o skip connections (more local minima)
...
## Loss Surface
- Can think of like Height Dimension
