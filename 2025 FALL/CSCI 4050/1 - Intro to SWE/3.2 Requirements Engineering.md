...
- Re-engineering
	...
	- Triggered by a technology enabler
- Interface Engineering
	- Provision of existing services in a new environment
	- Redesign of the UI of an existing system. The legacy system is untouched except for its UI
	- Triggered by a technology enabler or new market needs
...
1. **Introduction**
2. **Current syste**m (skip for greenfield engineering, and replace with a literature review of similar system)
3. **Proposed system**
	3.1 Overview
