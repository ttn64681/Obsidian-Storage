...
```
**Forwarding (or Bypassing)** resolves data hazards by sending the computed result directly from the pipeline stage where it's produced to the input of the stage where it's needed, _bypassing_ the register file.
```
